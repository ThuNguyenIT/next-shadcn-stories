...
import { TitleListSection } from "@/components/home/title-list-section";
import PageContainer from "@/components/layout/page-container";
import { StoryCard } from "@/components/story/story-card";
import { GetStoryByListResponse, IList, ListData } from "@/types";
  ...
  return (
    <PageContainer>
      <div className='space-y-2'>
        <TitleListSection title={state.list?.name || ""} />
